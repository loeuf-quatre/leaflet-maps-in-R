...
# What if you wanna spice it up with some demo data? Easy peasy!
...
birthRate <- read_excel("C:/Users/e115174/Documents/GitHub/maps/counties/data/VST01.xls", 
  sheet = 5, col_names = T)
...
group = 'Birth Rate') %>%
addLegend('bottomright', pal = colorNumeric("RdYlGn", texas$VST020207D), values = ~VST020207D,
    title = 'Birth Rate <br> (2007)', opacity = 1
  ) %>% 
addLayersControl(
    overlayGroups = c('Birth Rate'),
